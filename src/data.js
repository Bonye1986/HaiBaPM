...
export const taskSeed = [
  ...
  { id: "T-260802", phase: "1500-01-01", title: "核对审核状态流转", module: "管理后台", status: "待确认", owner: "王芳", confirmer: "李项目", priority: "P1", start: "2026-08-16", due: "2026-08-20", progress: 100, description: "核对待审核、审核通过、驳回和重新提交的状态与权限边界。" },
  ...
  { id: "T-260809", phase: "1500-01-01", title: "消息通知模板确认", module: "产品需求", status: "待确认", owner: "王芳", confirmer: "李项目", priority: "P2", start: "2026-08-15", due: "2026-08-21", progress: 100, description: "确认短信、站内信及邮件通知模板和触发条件。" },
...
export const dailyReportSeed = [
  ...
  { id: "DR-260818-02", name: "测试回归日报 · 2026-08-18", sender: "陈晨", sentAt: "2026-08-18 17:48", date: "2026-08-18", status: "待发送", phase: "1500-01-01", hours: 5, summary: "整理测试报告问题清单，完成登录链路和权限入口回归。", nextPlan: "跟进 P0 问题修复并更新测试报告终版。", blockers: "结算比例问题仍在修复中。" },
  ...
  { id: "DR-260816-01", name: "交付资料日报 · 2026-08-16", sender: "刘洋", sentAt: "2026-08-16 17:25", date: "2026-08-16", status: "待发送", phase: "1502-01-01", hours: 5, summary: "整理采购协同验收单、部署记录和操作手册。", nextPlan: "补充客户签字页后重新发送。", blockers: "验收单缺少客户签字页。" },
  { id: "DR-260815-01", name: "活动平台日报 · 2026-08-15", sender: "赵敏", sentAt: "2026-08-15 18:41", date: "2026-08-15", status: "待发送", phase: "1501-01-01", hours: 4, summary: "完成营销活动配置原型和关键交互说明。", nextPlan: "补充活动效果查看页面，准备评审。", blockers: "暂无。" },
